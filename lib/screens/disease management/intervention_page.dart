// screens/disease management/intervention_page.dart
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildTextField('Dosage Applied', _dosageController, 'e.g., 5', isNumber: true),
              const SizedBox(height: 16),
              _buildTextField('Unit', _unitController, 'e.g., ml'),
              const SizedBox(height: 16),
              _buildTextField(
                'Total Area Affected',
                _areaController,
