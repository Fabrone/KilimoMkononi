// admin_disease_management_page.dart
...
class AdminDiseaseManagementPage extends StatefulWidget {
  ...
  @override
  State<AdminDiseaseManagementPage> createState() => _AdminDiseaseManagementPageState();
}

class _AdminDiseaseManagementPageState extends State<AdminDiseaseManagementPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Admin Disease Management', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
  ...
  Future<void> _restoreIntervention(DiseaseIntervention intervention) async {
  ...
  Future<void> _hardDeleteIntervention(DiseaseIntervention intervention) async {
    final scaffoldMessenger = ScaffoldMessenger.of(context);
    ...
    if (confirm == true && mounted) {
      try {
        await FirebaseFirestore.instance.collection('diseaseinterventiondata').doc(intervention.id).delete();
