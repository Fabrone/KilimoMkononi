// lib/screens/pest management/view_interventions_page.dart
//
// Shows ALL records for this specific pest — both manual entries and
  ...
  Future<void> _load() async {
    ...
    try {
      final all = await FarmerIssueService.getSimilarCases(
        cropName:  '',           // all crops for this pest
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.pestData.name,
...
class _RecordCardState extends State<_RecordCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final accentColor = r.isAI ? const Color(0xFF6A1B9A) : _kMid;
              ...
              if (r.hasIntervention) ...[
                ...
                Container(
                  ...
                  child: const Row(children: [
                    ...
                    Text('No intervention recorded yet', style: TextStyle(fontSize: 13, color: Color(0xFF7A4F00))),
                  ]),
                ),
                const SizedBox(height: 12),
              ],

              if (r.amountText != null || r.area != null) ...[
                _secLabel('📏  Application details'),
                const SizedBox(height: 4),
                if (r.amountText != null) _detailRow('Amount', r.amountText!),
  ...
  Future<void> _showEditDialog() async {
    ...
    final result = await showDialog<String>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Edit intervention', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
    ...
    final result = await showDialog<DateTime>(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setS) => AlertDialog(
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
          backgroundColor: Colors.white,
          title: const Text('Set follow-up reminder', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
          content: InkWell(
            onTap: () async {
            ...
            child: Container(
              ...
              child: Row(children: [
                const Icon(Icons.calendar_today_rounded, size: 18, color: Color(0xFF5C6B5A)),
