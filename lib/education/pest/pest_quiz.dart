...
// ═══════════════════════════════════════════════════════════════════════════
//  PestQuizScreen
//  Hub — no AppBar (parent pest_home provides it).
// ═══════════════════════════════════════════════════════════════════════════
...
class _PestQuizScreenState extends State<PestQuizScreen> {
  ...
  void _showQuizBuilder() => showDialog(
        ...
        builder: (_) => EduQuizBuilder(
          ...
          topicLabel:    'Pest Management',
          geminiSubject: 'agricultural pest identification, integrated pest management (IPM), prevention and control methods for Kenyan crops including maize, beans, tomatoes and vegetables',
  ...
  Future<void> _saveQuiz(Map<String, dynamic> data) async {
    await FirestoreHelper.addContentToClass(
      ...
      {
        'type':      'quiz',
        'title':     data['title'] as String? ?? 'Pest Quiz',
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) => EduQuizScreen(
              ...
              classId:       widget.classId,
              isPrimary:     _isPrimaryClass(widget.classId),
              geminiSubject: 'agricultural pest identification, integrated pest management and control methods for Kenyan crops',
            ),
          ),
        );
      }
