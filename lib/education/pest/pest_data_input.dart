    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          EduAiLoadingButton(
            loading: _aiLoading,
            label: 'AI Analysis for this Pest',
            onPressed: () => _runAiPestAnalysis(null),
          ),
        ],
      ),
    );
                  ...
                  return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    OutlinedButton.icon(
                      onPressed: () async {
                        ...
                        setBtn(() => aiDraft = draft);
                      },
                      icon: const Icon(Icons.auto_awesome, size: 14, color: Colors.deepPurple),
