...
class _Img extends StatelessWidget {
  ...
  final double h;
  final double? w;
  const _Img(this.url, {this.h = 170}) : w = null;

  @override
  Widget build(BuildContext ctx) {
    final dpr = MediaQuery.devicePixelRatioOf(ctx);
    final cacheH = (h * dpr).round();
    final cacheW = w != null ? (w! * dpr).round() : null;
...
class PrimarySeedsPlantsScreen extends StatelessWidget {
  ...
  const PrimarySeedsPlantsScreen({
    super.key,
    required this.role,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: it.c.withValues(alpha: 0.08),
            blurRadius: 8,
        ...
        children: [
          ...
          if (_open) ...[
            ...
            Padding(
              ...
              child: Text(
                '🌱 Growth Stages — tap a stage to see',
                style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.bold,
                  color: it.c,
            ...
            Padding(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: it.stages.asMap().entries.map((e) {
                    final sel = e.key == _si;
            ...
            Padding(
              ...
              child: ClipRRect(
                ...
                child: SizedBox(
                  width: double.infinity,
                  height: 260,
                  child: _Img(it.stages[_si].url, h: 260),
                ),
              ),
            ),
            Padding(
