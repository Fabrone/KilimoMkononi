          ...
          child: Column(
            ...
            children: [
              ...
              _buildContactItem(
                ...
                icon: Icons.email,
                title: 'Email',
                value: 'support@jvalmacis.co.ke',
                onTap: () => _launchUrl('mailto:support@jvalmacis.co.ke'),
              ),
              _buildContactItem(
                context,
                icon: Icons.phone,
                title: 'Phone',
                value: '+254 795 802 020',
                onTap: () => _launchUrl('tel:+254 795 802 020'),
              ),
              _buildContactItem(
                context,
                icon: Icons.web,
                ...
                onTap: () => _launchUrl('https://jvalmacis.com#'),
              ),
              const SizedBox(height: 24),
